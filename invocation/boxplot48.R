...
gran1 <- read.csv("48/gran1.csv", header=TRUE, sep=",")
gran2 <- read.csv("48/gran2.csv", header=TRUE, sep=",")
gran4 <- read.csv("48/gran4.csv", header=TRUE, sep=",")
gran6 <- read.csv("48/gran6.csv", header=TRUE, sep=",")
gran12 <- read.csv("48/gran12.csv", header=TRUE, sep=",")
gran24 <- read.csv("48/gran24.csv", header=TRUE, sep=",")
gran48 <- read.csv("48/gran48.csv", header=TRUE, sep=",")
