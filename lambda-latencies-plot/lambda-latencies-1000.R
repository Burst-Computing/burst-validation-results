...
set1 <- read.csv("1000func-single256.csv", header=TRUE, sep=",")
set2 <- read.csv("1000func-biglambda.csv", header=TRUE, sep=",")
set3 <- read.csv("result-1000-256MB.csv", header=TRUE, sep=",")
set4 <- read.csv("result-1000-8192MB.csv", header=TRUE, sep=",")
